  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f7f6f3] px-4">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl p-8 
        ...
        {/* Title */}
        <h1 className="text-3xl font-semibold text-[#1a1916] mb-1 tracking-tight">
          Welcome back
        </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[#fafafa] border border-black/10 
        ...
        <button className="w-full flex items-center justify-center gap-2 
                           ...
                           py-2.5 rounded-lg text-sm text-gray-600 
